...
const Teachers = () => {
    ...
    useEffect(() => {
        dispath(listTeachers())
    }, [deleteModalopen, addTeacherModal, editTeacherModal]);
    ...
    return (
        <div className='px-5 pt-1'>
            <div className='mb-5'>
                <div>
                    <h2 className='text-gray-700 font-sans font-bold m-0'>Teachers</h2>
                ...
                <div className='my-5  flex items-center gap-3  justify-between'>
                    ...
                    <div className=''>
                        <button onClick={() => setAddTeacherModal(true)} className='mr-2 bg-zinc-100 border px-5 py-2 rounded-lg'>
                            ...
                            <Table.Body>
                                {teachers?.data?.data?.map((teacher, index) => (
                                    <Table.Row key={index} textAlign='center'>
                                        ...
                                        <Table.Cell>{teacher.sex === 1 ? 'Homme' : 'Femme'}</Table.Cell>
                                        <Table.Cell>{teacher.course}</Table.Cell>
                                        <Table.Cell>{teacher.email}</Table.Cell>
                                        <Table.Cell>
                                            <Chip
                                                label={teacher.phone1}
                                                variant="outlined"
                                                sx={{ margin: '0 3px ' }} />
                                            <Chip
                                                label={teacher.phone2}
                                                variant="outlined"
                                                sx={{ margin: '0 3px ' }} />
                                        </Table.Cell>
                                        <Table.Cell>
                                            ...
                                            {/* Editing Icon  */}
                                            <IconButton
                                                onClick={() => handleEditModal(teacher.id)}
                                            >
                                                {editIcon}
                                            </IconButton>
                                            {/* Deleteing Icon  */}
                                            <IconButton
                                                onClick={() => handelDeleteModal(teacher.id)}
                                            >
                                                {deleteIcon}
                                            </IconButton>
                                        </Table.Cell>
